...
const TeamAllTime = () => {
	...
	const fetchItems = async (teamIds: string[]) => {
		...
		try {
			await fetch('http://ec2-54-193-47-8.us-west-1.compute.amazonaws.com:8000/league_rankings/teamall/', requestOptions)
    ...
    return (
        <div>
            <h2>Selected Top teams with stats from all seasons:</h2>
